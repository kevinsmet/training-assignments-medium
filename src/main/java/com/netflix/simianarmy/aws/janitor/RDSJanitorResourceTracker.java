...
public class RDSJanitorResourceTracker implements JanitorResourceTracker {
     ...
     *
     */
    public RDSJanitorResourceTracker(DatabaseParameters databaseParameters, String dbTable) {
		HikariDataSource dataSource = new HikariDataSource();
		dataSource.setDriverClassName(databaseParameters.dbDriver);
		dataSource.setJdbcUrl(databaseParameters.dbUrl);
		dataSource.setUsername(databaseParameters.dbUser);
		dataSource.setPassword(databaseParameters.dbPass);
